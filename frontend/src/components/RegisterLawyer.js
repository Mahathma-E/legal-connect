...
const RegisterLawyer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('[FIREBASE] Creating lawyer account with email:', email);
      ...
      console.log('[BACKEND] Lawyer registered successfully');
      setSuccess(true);
    } catch (err) {
          ...
          <div className="glass-card" style={{ textAlign: 'center', padding: '40px 20px' }}>
            ...
            <div style={{
              ...
              <ol style={{ textAlign: 'left', paddingLeft: '20px' }}>
                ...
                <li>Wait for Admin approval for your Lawyer account</li>
    ...
    <div className="auth-container">
      <div className="auth-box">
        <div className="glass-card" style={{ textAlign: 'center' }}>
          <h2 style={{ marginBottom: '20px', background: 'linear-gradient(135deg, var(--color-primary), var(--color-accent))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontSize: '2rem' }}> Lawyer Registration </h2>
          <p className="muted" style={{ marginBottom: '30px' }}>Join the Legal Network</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <input
              type="text"
              placeholder="Bar Association Code"
              value={barCode}
